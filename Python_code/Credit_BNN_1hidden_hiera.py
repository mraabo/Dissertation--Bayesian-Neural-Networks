...
def construct_bnn(ann_input, ann_output, n_hidden):
    ...
    with pm.Model() as bayesian_neural_network:
        ...
        weights_in_1 = pm.Normal("w_in_1", mu1, sigma1, shape=(X_train.shape[1], n_hidden))
        ...
        weights_1_out = pm.Normal("weights_out", mu_out, sigma=sigma_out, shape=(n_hidden,1))
...
plt.show()
plt.savefig('Python_code/Credit_BNN_1hidden_hiera_confusion_matrix.pdf')
